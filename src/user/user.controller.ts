...
import { Controller, Get, Post, Put, Delete, Param, Body, BadRequestException, Res, HttpStatus } from '@nestjs/common';
...
export class UserController {
    ...
    @Delete(':email')
    async deleteUser(@Param('email') email: string, @Res() res: Response): Promise<Response> {
        try {
